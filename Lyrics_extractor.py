...
window.title('Lyrics_Extractor_by_Maanvir')#giving title
head=Label(window, text="Enter the song you want Lyrics for", font=('Calibri 20'))# a lable
head.pack(pady=20)
...
Message(window,textvariable=result, bg="grey").pack(side=TOP,anchor=W,fill=BOTH, expand=1)#displaying the lyrics
#create a button
Button(window, text="Submit",command=get_lyrics).pack()
